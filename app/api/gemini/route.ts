...
export async function POST(req:Request) {
    try {
        ...
        const prompt = "你是一名精通日语以及会熟练使用Markdown语法写作的人,同时擅长在Markdown中使用<ruby></ruby>标签来进行日语汉字的平假名标注,例如原文是:私は日本人です。 标注平假名后是:<ruby>私<rt>わたし</rt></ruby>は<ruby>日本人<rt>にほんじん</rt></ruby>です. 请将这段日语:["
